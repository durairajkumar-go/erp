...
{!! Form::open(array('route' => ['role.update', $data->id] , 'method' => 'PUT'),['class' => 'form']) !!}
                         ...
                         <div class="form-group">
                           <div class=" styled-input col-sm-6 col-md-3 col-lg-3 {{ $errors->first('name', 'has-error') }}">
                            ...
                            {{ Form::label('name',trans('messages.role name'),['class' => 'fill-this']) }}
                            </div>
                        </div>
                        
                        <div class="form-group">
                           <div class=" styled-input col-sm-6 col-md-3 col-lg-3 {{ $errors->first('short_name', 'has-error') }}">
                            {{ Form::text('short_name', $data->short_name, ['class' => 'form-control',(($errors->first('short_name')) || empty($erros)?'autofocus':null),'onfocus'=>'this.value = this.value','autocomplete' => 'off']) }}
                            {{ Form::label('name',trans('messages.short name')) }}
                            </div>
                        </div>
